...
namespace Project_DotNetCore.Base.Modules.Core.Filters
{
    public static class Enumeration
    {
        public static List<IdNameDto> GetAll<TEnum>(LetterCasing letterCasing = LetterCasing.Title) where TEnum : struct
        {
            ...
            myList.Sort((pair1, pair2) => string.Compare(pair1.Value, pair2.Value, StringComparison.Ordinal));
        ...
        public static List<IdNameDescriptionDto> GetDescriptionAll<TEnum>(LetterCasing letterCasing = LetterCasing.Title, bool sort = true) where TEnum : struct
        {
            var enumerationType = typeof(TEnum);
            ...
            foreach (int value in Enum.GetValues(enumerationType))
            {
                ...
                dictionary.Add(value, descriptionAttribute != null ? descriptionAttribute.Description : name.Humanize(letterCasing));
            }
